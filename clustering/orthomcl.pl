...
evalueExponentCutoff=-5";
	...
	my $cmd = "perl -w $scriptsDir/orthomclPairs.pl $outDir/config_step10 $outDir/orthomclPairs.log cleanup=yes";
...
sub step11{
	...
	system "perl -w $scriptsDir/orthomclDumpPairsFiles.pl $outDir/config_step10 $outDir";
}
